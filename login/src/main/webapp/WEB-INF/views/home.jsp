	...
	<div class="container g-5">
		<header class="d-flex align-items-center justify-content-center py-2 border-bottom">
			<div class="col-3 mb-0">
				<a class="navbar-brand" href="#" onclick="location.reload();"> <img src="./resources/img/logo.svg" alt="BOOKKKEUREOM" width="64" height="28" />
				</a>
			</div>
			<ul class="nav col-6 col-auto justify-content-center mb-0">
				<li><a href="#" class="nav-link px-3">E북</a></li>
				<li><a href="#" onclick="alert('로그인을 해주세요')" class="nav-link px-3">피드</a></li>
				<li><a href="#" class="nav-link px-3">검색</a></li>
				<li><a href="#" onclick="alert('로그인을 해주세요')" class="nav-link px-3">내정보</a></li>
			</ul>
