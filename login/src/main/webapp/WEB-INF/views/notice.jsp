...
<link rel="stylesheet" href="./resources/css/notice_alarm.css" />
		...
		<tbody>
			...
			<td width="170" valign="top" style="background-color: skyblue">
				...
				<div class="cs">
					...
					<ul>
						<li style="list-style: none"></li>
						<li style="list-style: none"><a href="FAQ.html"
							style="cursor: pointer; cursor: hand" class="user">FAQ
								조회</a></li>
						<li style="list-style: none"><a href="one_one.html"
					...
					<ul>
						<li style="list-style: none"></li>
						<li style="list-style: none"><a href="center.html"
