...
<link href="./resources/css/notice_alarm.css?ver" rel="stylesheet" />
<link rel="stylesheet"
...
<body>
	<div class="container">
		...
		<table width="1150" height="900" border="0" align="center" cellpadding="0"
			cellspacing="0">
			<tbody>
				<tr height="40">
				...
				<td width="170" valign="top" style="background-color: skyblue">
					...
					<div class="cs">
						<!--개인정보-->
						<div class="cs_first">개인정보</div>
						<ul>
							<li style="list-style: none"></li>
							<div class="cs_first"></div>
							<li style="list-style: none"><a href="new.do"
								style="cursor: pointer; cursor: hand" class="user">추천 도서</a></li>
							<div class="cs_first"></div>
					...
					<div class="tbl_row">
						<table>
							...
							<tr>
								...
								<script src="./resources/js/notice_alarm.js"></script>
							</tr>
						</table>
					</div>
				</td>
		...
		<footer class="py-4 mt-4 border-top">
			...
			<ul class="nav justify-content-start pt-1">
				...
				<li class="nav-item"><a href="#"
					class="nav-link ps-0 pe-3 py-0 text-body-secondary">저작권/도서오류 신고
						></a></li>
				<li class="nav-item"><a href="#"
