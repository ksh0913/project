...
<link rel="stylesheet" href="./resources/css/one_one.css" />
...
<body>
	...
	<table width="1000" border="0" align="center" cellpadding="0"
		...
		<tbody>
			...
			<td width="80" valign="top" style="background-color: skyblue">
				<div class="cs">
					<!--왼쪽 메뉴-->
				</div>
				<div class="cs">
			...
			<td width="*" valign="top"
				...
				<form id="form">
					...
					<button type="button" class="btn-btnbtn">Submit</button>
				</form> <script src="./resources/js/one_one.js">
					"use strict";
