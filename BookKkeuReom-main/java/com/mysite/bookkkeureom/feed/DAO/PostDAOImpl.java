...
public class PostDAOImpl implements PostDAO {
    ...
    public void increasePostLikes(int postId) throws Exception {
        sqlSession.update("PostMapper.increasePostLikes", postId);
    }

    @Override
    public void decreasePostLikes(int postId) throws Exception {
        sqlSession.update("PostMapper.decreasePostLikes", postId);
    }

    @Override
    public void createPostWithHashtags(PostDTO post) throws Exception {
        sqlSession.insert("PostMapper.createPostWithHashtags", post);
    }
}
