...
import com.mysite.bookkkeureom.model.vo.NewBookVO;

public class NewBookJavaApp {
...
//		System.out.println(responseText);
		...
		ArrayList<NewBookVO> list = new ArrayList<>();
		for (int i = 0; i < itemArr.size(); i++) {
			...
			book.setCategoryName(item.get("categoryName").getAsString());

			list.add(book);
		}
		for (NewBookVO b : list) {
