...
<body>
        ...
        <header class="d-flex align-items-center justify-content-center py-2 border-bottom">
            <div class="col-3 mb-0">
                <a class="navbar-brand" href="index.jsp"> 
                    <img src="./resources/img/logo.svg" alt="북끄럼" width="64" height="28" />
                </a>
            </div>
    ...
    <div class="form-group mb-3"> <!-- mb-3을 추가하여 마진을 적용 -->
        <label for="eventName">이벤트 이름</label>
        <input type="text" class="form-control" id="eventName" placeholder="이름 입력">
    </div>
    ...
    <div class="form-group mb-3">
        <label for="eventCoverImage">표지 이미지</label>
        <input type="file" class="form-control-file" id="eventCoverImage">
    </div>
    <div class="form-group mb-4"> <!-- 마지막 요소에는 조금 더 큰 마진을 줄 수 있음 -->
        <label for="eventContentImage">내용 이미지</label>
        <input type="file" class="form-control-file" id="eventContentImage">
    </div>
    <button type="submit" class="btn btn-primary mb-2">등록</button> <!-- 버튼에도 마진 적용 -->
    <button type="button" class="btn btn-secondary" onclick="location.href='/bookkkeureom/event'">취소</button>
</form>
	...
	<script src="./resources/js/event_register.js"></script>
