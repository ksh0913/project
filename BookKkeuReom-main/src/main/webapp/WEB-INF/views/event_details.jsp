...
<body>
    <div class="container g-5">
        <header class="d-flex align-items-center justify-content-center py-2 border-bottom">
            <div class="col-3 mb-0">
                <a class="navbar-brand" href="<%=request.getContextPath()%>/">
                    <img src="./resources/img/logo.svg" alt="BOOKKKEUREOM" width="64" height="28" />
                </a>
            </div>
        ...
        <p id="eventDates"></p>
        <img id="eventDetailImage" style="max-width: 100%;">
        <p id="eventOrganization"></p>
   ...
   <footer class="py-4 mt-4 border-top">
	...
	<script src="./resources/js/event_details.js"></script>
