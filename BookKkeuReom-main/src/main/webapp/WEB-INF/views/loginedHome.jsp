	...
	<div class="container g-5">
		<header class="d-flex align-items-center justify-content-center py-2 border-bottom">
			...
			<div class="col-md-3 text-end">
				<button class="btn btn-primary p-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" data-bs-dismiss="modal">로그아웃</button>
			</div>
		...
		<div id="favorite" class="d-flex gap-2 justify-content-start">
			<button class="btn btn-secondary rounded-pill py-0" type="button">자기계발 ></button>
			<button class="btn btn-secondary rounded-pill py-0" type="button">에세이 ></button>
			<button class="btn btn-secondary rounded-pill py-0" type="button">소설 ></button>
		</div>
			...
			<div class="row g-4">
				<div class="col">
					<div id="new-card-1" class="card shadow">
						<div class="card-header px-4 bg-gradient d-flex">
							<h5 id="new-title-1" class="card-title align-self-center mb-0"></h5>
						</div>
				...
				<div class="col">
					<div id="new-card-2" class="card shadow">
						<div class="card-header px-4 bg-gradient d-flex">
							<h5 id="new-title-2" class="card-title align-self-center mb-0"></h5>
						</div>
						<div class="card-body px-0 py-4 text-center">
				...
				<div class="col">
					<div id="new-card-3" class="card shadow">
						<div class="card-header px-4 bg-gradient d-flex">
							<h5 id="new-title-3" class="card-title align-self-center mb-0"></h5>
						</div>
						<div class="card-body px-0 py-4 text-center">
		...
		<div id="best" class="album">
			...
			<div class="row g-3">
				<div class="col">
					<div class="mb-3" style="height: 132px;">
						<div class="row g-0">
							<div class="col-4">
								<img src="" id="best-cover-1" class="card-img shadow"></img>
							</div>
				...
				<div class="col">
					<div class="mb-3" style="height: 132px;">
						<div class="row g-0">
							<div class="col-4">
								<img src="" id="best-cover-4" class="card-img shadow"></img>
							</div>
							<div class="col-2 text-center align-self-center">
				...
				<div class="col">
					<div class="mb-3" style="height: 132px;">
						<div class="row g-0">
							<div class="col-4">
								<img src="" id="best-cover-7" class="card-img shadow"></img>
							</div>
							<div class="col-2 text-center align-self-center">
				...
				<div class="col">
					<div class="mb-3" style="height: 132px;">
						<div class="row g-0">
							<div class="col-4">
								<img src="" id="best-cover-10" class="card-img shadow"></img>
							</div>
							<div class="col-2 text-center align-self-center">
			...
			<div class="row g-3">
				<div class="col">
					<div class="mb-3" style="height: 132px;">
						<div class="row g-0">
							<div class="col-4">
								<img src="" id="best-cover-2" class="card-img shadow"></img>
							</div>
							<div class="col-2 text-center align-self-center">
								<h5 id="best-rank-2" class="card-title mb-0"></h5>
							</div>
							<div class="col-6 align-self-center">
								<div class="card-body">
									<p id="best-title-2" class="card-text mb-1"></p>
									<p class="card-text">
										<small id="best-author-2" class="text-body-secondary"></small>
									</p>
								</div>
							</div>
						</div>
				...
				<div class="col">
					<div class="mb-3" style="height: 132px;">
						<div class="row g-0">
							<div class="col-4">
								<img src="" id="best-cover-5" class="card-img shadow"></img>
							</div>
							<div class="col-2 text-center align-self-center">
								<h5 id="best-rank-5" class="card-title mb-0"></h5>
							</div>
							<div class="col-6 align-self-center">
								<div class="card-body">
									<p id="best-title-5" class="card-text mb-1"></p>
									<p class="card-text">
										<small id="best-author-5" class="text-body-secondary"></small>
									</p>
								</div>
							</div>
						</div>
				...
				<div class="col">
					<div class="mb-3" style="height: 132px;">
						<div class="row g-0">
							<div class="col-4">
								<img src="" id="best-cover-8" class="card-img shadow"></img>
							</div>
							<div class="col-2 text-center align-self-center">
								<h5 id="best-rank-8" class="card-title mb-0"></h5>
							</div>
							<div class="col-6 align-self-center">
								<div class="card-body">
									<p id="best-title-8" class="card-text mb-1"></p>
									<p class="card-text">
										<small id="best-author-8" class="text-body-secondary"></small>
									</p>
								</div>
							</div>
						</div>
				...
				<div class="col">
					<div class="mb-3" style="height: 132px;">
						<div class="row g-0">
							<div class="col-4">
								<img src="" id="best-cover-11" class="card-img shadow"></img>
							</div>
							<div class="col-2 text-center align-self-center">
								<h5 id="best-rank-11" class="card-title mb-0"></h5>
							</div>
							<div class="col-6 align-self-center">
								<div class="card-body">
									<p id="best-title-11" class="card-text mb-1"></p>
									<p class="card-text">
										<small id="best-author-11" class="text-body-secondary"></small>
									</p>
								</div>
							</div>
						</div>
			...
			<div class="row g-3">
				<div class="col">
					<div class="mb-3" style="height: 132px;">
						<div class="row g-0">
							<div class="col-4">
								<img src="" id="best-cover-3" class="card-img shadow"></img>
							</div>
							<div class="col-2 text-center align-self-center">
								<h5 id="best-rank-3" class="card-title mb-0"></h5>
							</div>
							<div class="col-6 align-self-center">
								<div class="card-body">
									<p id="best-title-3" class="card-text mb-1"></p>
									<p class="card-text">
										<small id="best-author-3" class="text-body-secondary"></small>
									</p>
								</div>
							</div>
						</div>
				...
				<div class="col">
					<div class="mb-3" style="height: 132px;">
						<div class="row g-0">
							<div class="col-4">
								<img src="" id="best-cover-6" class="card-img shadow"></img>
							</div>
							<div class="col-2 text-center align-self-center">
								<h5 id="best-rank-6" class="card-title mb-0"></h5>
							</div>
							<div class="col-6 align-self-center">
								<div class="card-body">
									<p id="best-title-6" class="card-text mb-1"></p>
									<p class="card-text">
										<small id="best-author-6" class="text-body-secondary"></small>
									</p>
								</div>
							</div>
						</div>
				...
				<div class="col">
					<div class="mb-3" style="height: 132px;">
						<div class="row g-0">
							<div class="col-4">
								<img src="" id="best-cover-9" class="card-img shadow"></img>
							</div>
							<div class="col-2 text-center align-self-center">
								<h5 id="best-rank-9" class="card-title mb-0"></h5>
							</div>
							<div class="col-6 align-self-center">
								<div class="card-body">
									<p id="best-title-9" class="card-text mb-1"></p>
									<p class="card-text">
										<small id="best-author-9" class="text-body-secondary"></small>
									</p>
								</div>
							</div>
						</div>
				...
				<div class="col">
					<div class="mb-3" style="height: 132px;">
						<div class="row g-0">
							<div class="col-4">
								<img src="" id="best-cover-12" class="card-img shadow"></img>
							</div>
							<div class="col-2 text-center align-self-center">
								<h5 id="best-rank-12" class="card-title mb-0"></h5>
							</div>
							<div class="col-6 align-self-center">
								<div class="card-body">
									<p id="best-title-12" class="card-text mb-1"></p>
									<p class="card-text">
										<small id="best-author-12" class="text-body-secondary"></small>
									</p>
								</div>
							</div>
						</div>
		...
		<footer class="py-4 mt-4 mb-2 border-top">
			...
			<div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
				<div class="col-4 d-flex align-items-center">
					<a href="/" class="text-body-secondary text-decoration-none"> <img src="./resources/img/logo.svg" alt="BOOKKKEUREOM" width="68.5" height="30" />
					</a>
				</div>
			...
			<p class="text-body-secondary mt-4 mb-0">&copy; 2024 북끄럼 All rights reserved.</p>
		</footer>
	</div>
